...
class HeaderSch extends Component {
    ...
    if(this.props.conference.logo){
      ...
      return (
        <View style={{flex:1, alignItems: "center"}}>
          <Text style={{color: config.SECONDARY_BG_COLOR, fontSize: 18, fontWeight: "700"}}>challenges</Text>
        </View>
      );
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(HeaderSch);